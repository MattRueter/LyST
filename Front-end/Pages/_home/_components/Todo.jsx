...
function Todo ({todo, projectName, priority, id, status, text}) {
        ...
        return(
            <li key={id}>
                <Card variant="outlined" sx={{margin:"2%"}}>
                    <CardContent>
                        <Typography sx={{fontSize : 24, textDecorationLine: text.textDecorationLine}}>{todo}</Typography>
                        <Typography sx={text}>Project: {projectName}</Typography>
                        <Typography sx={text}>Priority: {priority} </Typography>
